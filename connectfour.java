...
public class connectfour extends Application {
    ...
    private MenuBar createMenu() {
        ...
        MenuItem aboutDevoloper = new MenuItem("About Developer");
        aboutDevoloper.setOnAction(event -> aboutDeveloper());

        helpMenu.getItems().addAll(aboutGame, separator, aboutDevoloper);
    ...
    private void aboutDeveloper() {
        ...
        alert.setHeaderText("Piyush Patil");
